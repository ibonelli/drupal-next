...
- Drupal 10 Docksal Install: [DrupalDocksal.md](./README_DrupalDocksal.md)
- My notes: [DrupalNext.md](./README_DrupalNext.md)

Original version was designed for D9 Unami, so I had to tweak it to work with D10 version (see first commit).
